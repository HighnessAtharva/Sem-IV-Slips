...
class InvalidEmailID extends Exception{
 ...
 //in all exception handling programs use try catch blocks. Throw the exception is the try block, catch the same exception in the catch block and you will get a non-messy non-cluttered terminal output even when exception occurs. Cleanest way to handle. Never attempt exception handling programs without wrapping risky and error prone statements in the try block Atharva. Remember!
